...
import BaseCard from "../../BaseCard"; // plasmic-import: cHa-1dWJkReo/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: Qp6JNMzQtXlL/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox__mXy0R)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__paPzg)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__ugvKl)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__vqpae)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__jFrMx)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet___3Y6UQ)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.freeBox__dpSgd)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <LinkButton
                  text={"Get started"}
