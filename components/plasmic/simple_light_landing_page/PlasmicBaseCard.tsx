...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: cHa-1dWJkReo/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.freeBox__gsExx, {
          [sty.freeBox__long__gsExxLimzY]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__vNHfs, {
            [sty.freeBox__long__vNHfsLimzY]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__rUyDp)}
                role={"img"}
              />
            ),
