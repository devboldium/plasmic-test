...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: nGzOx1AIQbg/css

import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: CNWsmuVwUGCD/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__rayTl)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__tNc5)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.freeBox__a6AK)}>
          <SphereIcon
