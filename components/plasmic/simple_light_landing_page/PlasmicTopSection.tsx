...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: emquuw6mI8y/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox___5Bivm)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__ywKol)}
        >
          <div className={classNames(defaultcss.all, sty.freeBox___9MSz)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__dnDMx)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__trDni)}
            text={"Start free trial"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__zX9IT)}
            text={"Learn more"}
            type={"solidBlack" as const}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.freeBox__jkOa)}>
          <img
