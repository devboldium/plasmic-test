...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: 4Gtpm8PzZu-D/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__wBCuU)}
      >
        <div className={classNames(defaultcss.all, sty.freeBox___8ApQm)}>
          <div className={classNames(defaultcss.all, sty.freeBox__tCn)}>
            {p.renderPlasmicSlot({
