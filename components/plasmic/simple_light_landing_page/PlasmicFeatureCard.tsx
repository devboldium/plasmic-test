...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: RDaghYZiD39/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox___2Srhp, {
            [sty.freeBox__long___2SrhpdjmrZ]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          <div
            className={classNames(defaultcss.all, sty.freeBox__tUiuM, {
              [sty.freeBox__long__tUiuMdjmrZ]: hasVariant(
                variants,
                "long",
                "long"
              )
          ...
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(defaultcss.all, sty.svg__ztsO7)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__oq2Sf, {
          [sty.freeBox__long__oq2SFdjmrZ]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox___44NjY, {
            [sty.freeBox__long___44NjYdjmrZ]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__bwFtD)}
                role={"img"}
              />
            ),
