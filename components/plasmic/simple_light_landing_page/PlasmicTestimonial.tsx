...
import Avatar from "../../Avatar"; // plasmic-import: oGW235FJSBGI/component
...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: vyXIAsX9YXu6/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: LbrODol7zvZh/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox___6VUgb)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox___7Lyxp)}
        >
          <div
            className={classNames(
              defaultcss.all,
